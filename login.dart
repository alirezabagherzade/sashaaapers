import 'package:alirezabagherzadeh/listposts.dart';
import 'package:alirezabagherzadeh/register.dart';
            ...
            if (reg() == true) {
              ...
              showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    title: Text('dont have this account'),
                    content: new Text('Please Register'),
                  actions: <Widget>[
                      FlatButton(
                        child: Text('Ok'),
                        onPressed: () {
